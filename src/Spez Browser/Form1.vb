...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ElseIf My.Settings.Theme = "Dark" Then
            ...
            Button3.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\reload.png"))
            Button3.Text = ""
            Button3.FlatStyle = FlatStyle.Flat
            Button6.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\addtab.png"))
            Button6.Text = ""
            Button6.FlatStyle = FlatStyle.Flat
            Button5.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\menu.png"))
            Button5.Text = ""
            Button5.FlatStyle = FlatStyle.Flat

            'buttoncm
            Button4.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\Close.png"))
            Button7.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\fullscreen.png"))
            Button8.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\minimize.png"))
            Button4.Text = ""
    ...
    Private Sub NewTabToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        NewTab.Controls.Add(NewBrowser)
        NewBrowser.Dock = DockStyle.Fill
        NewBrowser.Navigate(My.Settings.Homepage.ToString)
        TabControl1.SelectedTab = NewTab
        AddHandler NewBrowser.ProgressChanged, AddressOf LoadingWeb
        AddHandler NewBrowser.DocumentCompleted, AddressOf Done
    End Sub
    ...
    Private Sub Button4_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.MouseHover
        Try
            Button4.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\Close_hover.png"))
        Catch ex As Exception
    ...
    Private Sub Button7_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button7.MouseHover
        Try
            Button7.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\fullscreen_hover.png"))
        Catch ex As Exception
    ...
    Private Sub Button8_MouseHover(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button8.MouseHover
        Try
            Button8.BackgroundImage = Image.FromFile(System.IO.Path.Combine(Application.StartupPath, "themes\" & My.Settings.Theme & "\minimize_hover.png"))
        Catch ex As Exception
    ...
    Public Sub OpenHistory()
        Try
            Dim a As String
            Dim b As String
            a = "/data/htmldoc/files/spezbrowser/history.html"
            ...
            If b Then
                ...
                Dim c As String
                Dim d As String
                c = "/data/htmldoc/files/spezbrowser/history.html"
    ...
    Public Sub OpenBookmarks()
        Try
            Dim a As String
            Dim b As String
            a = "/data/htmldoc/files/spezbrowser/bookmarks.html"
            b = InStr(TextBox1.Text, a)
            If b Then
                Timer1.Enabled = False
                Button1.PerformClick()
                Dim c As String
                Dim d As String
                c = "/data/htmldoc/files/spezbrowser/bookmarks.html"
                d = InStr(TextBox1.Text, a)
                If d Then
                    ShowBookmarksToolStripMenuItem.PerformClick()
                    Timer1.Enabled = True
                    Timer2.Enabled = True
                End If
            End If
    ...
    Private Sub Timer2_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer2.Tick
        Library.TopMost = True
        Library.TopMost = False
